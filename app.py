...
#Submit2 = st.button("How can I improve my resume points?")
...
Highlight the strengths and weakness of the applicant in relation to the job description.
"""
...
the job description. First output should come as percentage and then Keyword missing as second output.
"""
if submit1: 
    if uploaded_file is not None:
